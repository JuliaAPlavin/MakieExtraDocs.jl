...
let
	...
	Record(current_figure(), 2:100) do n_
		n[] = n_
	end
end
...
visdata = @p VLBI.load(joinpath(pkgdir(VLBI), "test/data/SR1_3C279_2017_101_hi_hops_netcal_StokesI.uvfits")) |> table |> filter(_.stokes ∈ (:LL, :RR))
...
barplot(FPlot(1:10, (@o _), (@o _^2)), doaxis=true), barplot(FPlot(1:10, (@o _), (@o _^2)), direction=:x, doaxis=true)

# ╔═╡ 1a4cc0d0-d6cd-48bf-ac8a-0416b10c470a
barplot(FPlot(1:10, string, (@o _^2)), doaxis=true)

# ╔═╡ d715528e-166b-43e6-b7d1-74e8b9381c74
let fp = FPlot(1:10, (@o _), (@o MCM.:±(_^2, 5/√_)))
	lines(fp, doaxis=true)
	rangebars!(fp)
	current_figure()
end

# ╔═╡ d5b179ba-6e05-479b-8c01-8e7759890d30
rangebars(FPlot(1:10, (@o _), (@o _^2 ± 5/√_)), doaxis=true), rangebars(FPlot(1:10, (@o _^2 ± 5/√_), (@o _)), doaxis=true, direction=:x)
...
let
	...
	fig = Figure()
	scatter(fig[1,1], fplt, doaxis=true)
...
Makie.convert_arguments(ct::Type{<:AbstractPlot}, m::MyObj) = Makie.convert_arguments(ct, FPlot(1:10, (@o _+1), (@o _^2), color=sqrt); doaxis=true)
...
manifest_format = "2.0"
project_hash = "f1025f2d6d1a72f266a3004c49e446bb42d8a2c5"
...
deps = ["AccessorsExtra", "DataPipes", "IntervalSets", "LinearAlgebra", "StaticArrays", "StructHelpers", "Unitful", "UnitfulAstro"]
git-tree-sha1 = "85a98df249c6f630f7492907ae4ee34f6853353c"
...
[[deps.VLBIData]]
deps = ["AccessorsExtra", "AxisKeys", "DataManipulation", "DateFormats", "Dates", "DelimitedFiles", "FITSIO", "InterferometricModels", "PrecompileTools", "PyFormattedStrings", "Reexport", "StaticArrays", "StructArrays", "Tables", "Unitful", "UnitfulAngles", "UnitfulAstro"]
git-tree-sha1 = "b7d0d066709f4de5ba5803f6168115e2eee6906f"
...
git-tree-sha1 = "01e640064f33f7f6b29244f6b5eeb75e3705dcbc"
