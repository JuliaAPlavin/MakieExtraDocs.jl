...
# ╔═╡ f8281143-3915-49c9-a3de-5836f5c3f693
...
# ╔═╡ 260bc977-9592-4703-bd0a-9dfb0c0506ce
md"""
# GeoMakie

`MakieExtra` provides two functions:
- to switch GeoAxis to radians, the natural units for spherical coordinates,
- to automatically split lines and polygons at the seam.
"""

# ╔═╡ 47cdb564-15ec-4669-960a-a1a1124007f2
MakieExtra.GeoAxis_radians!()

# ╔═╡ c53044c1-b825-45f6-b9a3-ff3e2ba1a331
MakieExtra.GeoAxis_splitwrap!();

# ╔═╡ 3f4f373d-6102-4358-95b2-bba4bfbd813d
let
	fig = Figure()
	ax = GeoAxis(fig[1,1])
	lines!(0..4.5, x -> sin(6*x))
	resize_to_layout!()
	fig
end

# ╔═╡ cd6cf530-0141-4785-ad3d-96db1bc1d84e
let
	fig = Figure()
	ax = GeoAxis(fig[1,1])
	poly!(Circle.(Point.([2, 3.1, 3.15], [0, -0.3, 0.7]), [0.2, 0.15, 0.1]))
	resize_to_layout!()
	fig
end
...
let
	...
	Axis(Figure()[1,1], limits=(@lift ($xlims, nothing)))
	lines!(x -> sin(1/x))

	Record((@p maprange(log, 10, 0.01, length=200) [__; reverse(__)])) do r
		xlims[] = 0..r
	end
end
...
[compat]
Animations = "~0.4.2"
AxisKeysExtra = "~0.1.26"
Colors = "~0.13.1"
DataManipulation = "~0.1.21"
GLMakie = "~0.13"
GeoMakie = "~0.7.16"
IntervalSets = "~0.7.13"
MakieExtra = "~0.2"
...
manifest_format = "2.0"
project_hash = "8a61d2f82ec5e178e1a41eee574293ba26e714ef"
...
git-tree-sha1 = "0e45173a40f7750190f10c3121c6cad3c6cb63c9"
...
git-tree-sha1 = "0a13950999382864313a74cb919d9a00325fd865"
uuid = "54e234d5-9986-40d8-815f-a5e42de435f6"
version = "0.2.2"
weakdeps = ["GLMakie", "GeoMakie"]
