...
# ╔═╡ 0750c478-164f-45a9-bb01-8942f4d53873
using Accessors
...
let
	data = [(0., 1.), (1., 0.)]
	fplt = FPlot(data, first, last)
	fig,ax,plt = axplot(scatter)(fplt; label="Points")
	hlines!(mean(last, data), label="Average")
	axislegend()
	fig
end
...
let
	data = Observable([(0., 1.), (1., 0.)])
	fplt = @lift FPlot($data, first, last)
...
git-tree-sha1 = "54b0189fc7406e714cee965e480d1808a93f3dac"
